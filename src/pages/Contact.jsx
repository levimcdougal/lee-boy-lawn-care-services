...
const faqs = [
  ...
  { q: 'How far do you travel?', a: 'Lee Boy Lawn Service covers residential and commercial properties within about a 60-mile radius.' },
...
export default function Contact() {
  return <main className="page-wrapper">
    <section className="page-hero"><p className="section-label light">Contact us</p><h1>Let’s make your lawn<br /><em>look its best.</em></h1><p>Call or text Lee Boy Lawn Service for a free estimate. Tell us what you need and we’ll take it from there.</p></section>
    <section className="contact-section"><div className="section-inner contact-layout">
      <FadeIn><div className="contact-copy"><p className="section-label">Start a conversation</p><h2>Simple, local lawn care starts here.</h2><p>No complicated forms or long waits. Reach out directly and we’ll respond as soon as we can.</p>
        <a className="big-phone" href="tel:+18035918147"><span><Phone size={24} /></span><div><small>Call Lee Boy</small>(803) 591-8147</div><ArrowRight size={22} /></a>
      </div></FadeIn>
    ...
    <section className="faq-section"><div className="section-inner">
      <FadeIn><div className="faq-heading"><p className="section-label">Good to know</p><h2>Frequently asked questions.</h2><p>Quick answers to common questions about working with Lee Boy Lawn Service.</p></div></FadeIn>
